...
/**
 * This class implements a GUI dialog window for the application sumo database that gives the user the opportunity to update a coach.
 * @author Takeyoshi
 * @version 1.0
 */
public class UpdateCoachDialog extends JDialog {

	private static final long serialVersionUID = 5082780301561766502L;
	...
	/**
	 * This constructs a dialog window for updating a coach.
	 */
	public UpdateCoachDialog() {
		setAlwaysOnTop(true);
		pack();
		...
		}
		{
			...
			gbc_comboBoxHighestRank.insets = new Insets(0, 0, 5, 5);
		...
		}
		{
			...
			getContentPane().add(buttonPane, BorderLayout.SOUTH);
			{
				...
				btnSaveUpdate.setActionCommand("OK");
	...
	/**
	 * This method returns the instance variable of a JTextField object, holding the name of a coach.
	 * @return a JTextField object, holding the name of a coach.
	 */
	...
	/**
	 * This method returns the instance variable of a JTextField object, holding the total number of competitive wins for a coach.
	 * @return a JTextField object, holding the total number of competitive wins for a coach.
	 */
	...
	/**
	 * This method returns the instance variable of a JTextField object, holding the total number of competitive losses for a coach.
	 * @return a JTextField object, holding the total number of competitive losses for a coach.
	 */
	...
	/**
	 * This method returns the instance variable of a JComboBox object, holding the birth year of a coach.
	 * @return a JComboBox object, holding the birth year of a coach.
	 */
	...
	/**
	 * This method returns the instance variable of a JComboBox object, holding the birth month of a coach.
	 * @return a JComboBox object, holding the birth month of a coach.
	 */
	...
	/**
	 * This method returns the instance variable of a JComboBox object, holding the birth day of a coach.
	 * @return a JComboBox object, holding the birth day of a coach.
	 */
	...
	/**
	 * This method returns the instance variable of a JComboBox object, holding the highest rank of a coach.
	 * @return a JComboBox object, holding the highest rank of a coach.
	 */
	...
	/**
	 * This method returns the instance variable of a JComboBox object, holding the retired year of a coach.
	 * @return a JComboBox object, holding the retired year of a coach.
	 */
	...
	/**
	 * This method returns the instance variable of a JComboBox object, holding the retired month of a coach.
	 * @return a JComboBox object, holding the retired month of a coach.
	 */
	...
	/**
	 * This method returns the instance variable of a JComboBox object, holding the club name a coach coaching at.
	 * @return a JComboBox object, holding the club name a coach coaching at
	 */
	...
	/**
	 * This method returns the instance variable of a JButton object, representing a save button for updating coaches.
	 * @return a JButton object, for updating coaches.
	 */
