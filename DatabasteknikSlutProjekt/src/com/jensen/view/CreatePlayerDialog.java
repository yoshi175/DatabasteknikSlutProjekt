...
/**
 * This class implements a GUI dialog window for the application sumo database that gives the user the opportunity to create a player.
 * @author Takeyoshi
 * @version 1.0
 */
public class CreatePlayerDialog extends JDialog {

	private static final long serialVersionUID = -8823903879582166808L;
	...
	/**
	 * This constructs a dialog window for creating a player.
	 */
	public CreatePlayerDialog() {
		...
		}
		{
			...
			getContentPane().add(buttonPane, BorderLayout.SOUTH);
			{
				...
				buttonPane.add(btnAddPlayer);
				getRootPane().setDefaultButton(btnAddPlayer);
			}
			{
	...
	/**
	 * This method returns the instance variable of a JTextField object, holding the name of a new player.
	 * @return a JTextField object, holding the name of a new player.
	 */
	...
	/**
	 * This method returns the instance variable of a JTextField object, holding the height of a new player.
	 * @return a JTextField object, holding the height of a new player.
	 */
	...
	/**
	 * This method returns the instance variable of a JTextField object, holding the weight of a new player.
	 * @return a JTextField object, holding the weight of a new player.
	 */
	...
	/**
	 * This method returns the instance variable of a JTextField object, holding a new players native city.
	 * @return a JTextField object, holding a new players native city.
	 */
	...
	/**
	 * This method returns the instance variable of a JComboBox object, holding the birth year of a new player.
	 * @return a JComboBox object, holding the birth year of a new player.
	 */
	...
	/**
	 * This method returns the instance variable of a JComboBox object, holding the birth month of a new player.
	 * @return a JComboBox object, holding the birth month of a new player.
	 */
	...
	/**
	 * This method returns the instance variable of a JComboBox object, holding the birth day of a new player.
	 * @return a JComboBox object, holding the birth day of a new player.
	 */
	...
	/**
	 * This method returns the instance variable of a JComboBox object, holding the rank of a new player.
	 * @return a JComboBox object, holding the rank of a new player.
	 */
	...
	/**
	 * This method returns the instance variable of a JComboBox object, holding a new players coach name.
	 * @return a JComboBox object, holding a new players coach name.
	 */
	...
	/**
	 * This method returns the instance variable of a JComboBox object, holding a new players club name.
	 * @return a JComboBox object, holding a new players club name.
	 */
	...
	/**
	 * This method returns the instance variable of a JButton object, representing a add button for creating players.
	 * @return a JButton object, for adding players.
	 */
